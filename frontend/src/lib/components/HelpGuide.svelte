        ...
        {:else if active === 'project-dashboard'}
          ...
          <section>
            ...
            <ul class="text-sm text-slate-300 space-y-1 ml-3">
              ...
              <li><span class="font-medium text-slate-100">Project Settings</span> — edit project metadata, what-if scenarios, scenario chart copies and edits, scenario comparison, baseline promotion, export settings, compliance-mode audit verification, database encryption, document fonts, and Resource Capacity calendars. See <button onclick={() => nav('encryption')} class="text-cyan-400 underline hover:text-cyan-300">Database Encryption</button> and <button onclick={() => nav('export-signing')} class="text-cyan-400 underline hover:text-cyan-300">Export &amp; Signing</button>.</li>
            </ul>
          </section>
