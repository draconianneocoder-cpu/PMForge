        ...
        {:else if active === 'cpm'}
          ...
          <section class="mb-5">
            ...
            <ol class="space-y-2 text-sm text-slate-300 list-decimal list-inside">
              ...
              <li><span class="font-medium text-slate-100">Add risk estimates.</span> For uncertain tasks, enter optimistic, likely, and pessimistic durations, then run Monte Carlo from the CPM editor aside to review P50/P80/P90 finish days, the finish-probability S-curve, and critical drivers.</li>
