...
- **Remaining Phase 1 sequencing:** resource-calendar/capacity planning built on the existing resource layer; tamper-evident audit now has an additive schema/API foundation; scenario analysis remains a separate schema slice. Avoid reintroducing floating-point currency in SQL or Go.
